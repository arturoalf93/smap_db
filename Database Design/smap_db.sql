...
CREATE TABLE IF NOT EXISTS `smap_production`.`vendors_c` (
  ...
  INDEX `fk_vendors_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`users_c` (
  ...
  INDEX `fk_users_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`parent_categories_c` (
  ...
  `user_id` INT NOT NULL,
  PRIMARY KEY (`pcid`),
  INDEX `fk_parent_categories_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`subcategories_c` (
  ...
  INDEX `fk_subcategories_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`current_quarteryear_c` (
  ...
  INDEX `fk_current_quarteryear_users_idx` (`user_id` ASC),
  CONSTRAINT `fk_current_quarteryear_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`elements_c` (
  ...
  INDEX `fk_elements_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`rfi_vendors_c` (
  ...
  INDEX `fk_rfi_vendors_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`rfi_analysts_c` (
  ...
  INDEX `fk_rfi_analysts_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`vendor_attachments_c` (
  ...
  INDEX `fk_vendor_attachments_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`modules_c` (
  ...
  `user_id` INT NOT NULL,
  PRIMARY KEY (`mid`),
  INDEX `fk_modules_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`vendor_modules_c` (
  ...
  INDEX `fk_vendor_modules_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`module_elements_c` (
  ...
  INDEX `fk_module_elements_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`weights_elements_c` (
  ...
  INDEX `fk_weights_elements_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_weights_elements_elements`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_weights_elements_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`weights_categories_c` (
  ...
  INDEX `fk_weights_categories_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_weights_categories_categories`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_weights_categories_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`price_scores_c` (
  ...
  INDEX `fk_price_scores_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_price_scores_personas`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_price_scores_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`references_c` (
  ...
  INDEX `fk_references_users_idx` (`user_id` ASC),
  CONSTRAINT `fk_references_vendors`
    FOREIGN KEY (`vendor_id`)
    REFERENCES `smap_production`.`vendors_c` (`vendorid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_references_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`reference_modules_c` (
  ...
  INDEX `fk_modules_idx` (`m_id` ASC),
  INDEX `fk_reference_modules_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_reference_modules_modules`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_reference_modules_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`c_i_questions_c` (
  ...
  INDEX `fk_c_i_questions_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`c_i_answers_c` (
  ...
  INDEX `fk_c_i_answers_users_idx` (`user_id` ASC),
...
CREATE TABLE IF NOT EXISTS `smap_production`.`survey_questions_c` (
  ...
  INDEX `fk_survey_questions_users_idx` (`user_id` ASC),
  CONSTRAINT `fk_survey_questions_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`weights_survey_questions_c` (
  ...
  INDEX `fk_weights_survey_questions_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_weights_survey_questions_survey_questions`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_weights_survey_questions_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`survey_answers_c` (
  ...
  INDEX `fk_survey_answers_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_survey_answers_references`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_survey_answers_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`user_assigned_subcategories_c` (
  ...
  INDEX `fk_user_assigned_subcategories_users_idx` (`user_id` ASC),
  ...
  CONSTRAINT `fk_user_assigned_categories_categories`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_assigned_subcategories_users`
    FOREIGN KEY (`user_id`)
    REFERENCES `smap_production`.`users_c` (`userid`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `smap_production`.`calendar_vendors_c` (
  ...
  `vendor_id` INT UNSIGNED NOT NULL,
  `user_id` INT NULL,
  `calendar_vendors_ccol` VARCHAR(45) NOT NULL,
